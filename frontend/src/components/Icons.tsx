/**
 * Curated Lucide-style line icons. 1.75 stroke, currentColor, 16px nominal.
 *
 * Paths copied directly from lucide.dev so we don't add a runtime dependency
 * for a small handful of glyphs. Pass `size` to override; `className` and
 * inline `style` pass through.
 */
